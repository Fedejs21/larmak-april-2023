...
class WPVolter_Widget_Extends
{
    ...
    function extend_widget_form( $widget, $return, $instance )
    {
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-use_theme_style"><?php esc_html_e( 'Use Theme Style', 'energia' ); ?></label>
        </p>
        <?php
        }
        ...
        ?>
        <p>
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-el_class"><?php esc_html_e( 'CSS Class', 'energia' ); ?></label>
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-hide_title"><?php esc_html_e( 'Hide widget title', 'energia' ); ?></label>
        </p>
        <?php
