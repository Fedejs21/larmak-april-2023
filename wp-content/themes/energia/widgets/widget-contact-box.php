...
class CMS_Contact_Box_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('* Contact Box', 'energia'),
            array('description' => esc_html__('Contact Box Widget', 'energia'),)
        );
    }
    ...
    function widget($args, $instance)
    {
        ...
        <div class="cms-contact-box widget" style="background-image: url('<?php echo esc_url($background_img_url)?>');">
            <div class="widget-icon">
                <img src="<?php echo esc_url($widget_icon); ?>" alt="<?php echo esc_attr__('widget icon', 'energia')?>">
            </div>
            <?php if (!empty($title)) : ?>
                <h3 class="box-title">
                    <?php
    ...
    function form($instance)
    {
        ...
        ?>
        <p>
            <label for="<?php echo esc_url($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'energia'); ?></label>
        ...
        <div class="energia-image-wrap">
            <label for="<?php echo esc_url($this->get_field_id('background_img')); ?>"><?php esc_html_e('Background Image', 'energia'); ?></label>
            ...
            if ($background_img != "") {
                ?>
                <a href="#" class="energia-select-image" style="display: none;"><?php esc_html_e('Select Image', 'energia'); ?></a>
                <a href="#" class="energia-remove-image"><?php esc_html_e('Remove Image', 'energia'); ?></a>
                <?php
            } else {
                ?>
                <a href="#" class="energia-select-image"><?php esc_html_e('Select Image', 'energia'); ?></a>
                <a href="#" class="energia-remove-image" style="display: none;"><?php esc_html_e('Remove Image', 'energia'); ?></a>
                <?php
            }
            ?>
        </div>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('description')); ?>"><?php esc_html_e('Description', 'energia'); ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>"><?php esc_html_e( 'Button Text', 'energia' ); ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('button_link')); ?>"><?php esc_html_e( 'Button Link', 'energia' ); ?></label>
