...
if(!function_exists('energia_register_custom_icon_library')){
    add_filter('elementor/icons_manager/native', 'energia_register_custom_icon_library');
    function energia_register_custom_icon_library($tabs){
        $custom_tabs = [
            'extra_icon1' => [
                'name' => 'material',
                'label' => esc_html__( 'Material Design Iconic', 'energia' ),
            ...
            'extra_icon2' => [
                'name' => 'flaticon',
                'label' => esc_html__( 'Flaticon', 'energia' ),
