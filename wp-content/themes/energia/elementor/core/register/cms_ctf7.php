...
if(class_exists('WPCF7')) {
    ...
    if ($cf7) {
        ...
        $contact_forms[esc_html__('No contact forms found', 'energia')] = 0;
    }
    ...
    etc_add_custom_widget(
        array(
            'name' => 'cms_ctf7',
            'title' => esc_html__('Contact Form 7', 'energia'),
            ...
            'params' => array(
                'sections' => array(
                    ...
                    array(
                        'name' => 'textarea_size',
                        'label' => esc_html__('Texarea Size', 'energia'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                                'name'  =>  'message_height',
                                'type'  =>  \Elementor\Controls_Manager::SLIDER,
                                'label' => esc_html__('Message Height', 'energia'),
                                'size_units' => ['px'],
                                'range' => [
                                    'px' => [
                                        'min' => 120,
