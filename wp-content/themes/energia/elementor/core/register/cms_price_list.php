...
etc_add_custom_widget(
    array(
        'name' => 'cms_price_list',
        'title' => esc_html__('Price List', 'energia'),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'list_title',
                            'label' => esc_html__('List Title', 'energia'),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'label_block' => true,
                        ),
                        array(
                            'name' => 'price',
                            'label' => esc_html__('Add Item', 'energia'),
                            'type' => \Elementor\Controls_Manager::REPEATER,
                            'controls' => array(
                                array(
                                    'name' => 'item_text',
                                    'label' => esc_html__('Item Text', 'energia'),
                                    'type' => \Elementor\Controls_Manager::TEXTAREA,
                                    'label_block' => true,
                                ),
                                array(
                                    'name' => 'item_price',
                                    'label' => esc_html__('Item Price', 'energia'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'label_block' => true,
                                ),
                            ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Text List Color', 'energia'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'list_price_bg',
                            'label' => esc_html__('List Price Background', 'energia'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'box_padding',
                            'label' => esc_html__('Box Padding', 'energia'),
