...
<?php if (is_array($posts)): ?>
    <div id="<?php echo esc_attr($html_id) ?>" class="cms-service-carousel layout1 cms-slick-slider">
                    ...
                    <div class="grid-item-inner">
                        ...
                        <div class="entry-body">
                            ...
                            <div class="entry-readmore">
                                <a class="service-readmore btn btn-secondary" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php echo esc_html__("Read More", 'energia'); ?> <i class="fac fac-arrow-right"></i></a>
                            </div>
                    </div>
                    </div>
                </div>
