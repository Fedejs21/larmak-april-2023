        ...
        <div class="fancy-box-inner">
                        ...
                        <div class="carousel-item">
                            <div class="carousel-item-inner">
                                <div class="item-content">
                                    <?php
                                    if (!empty($box['item_index'])){
                                        ?>
                                        <div class="item-index"><?php echo esc_html($box['item_index']); ?></div>
                                        <?php
                                    }
                                    ?>
                                    <h3 class="item-title">
            ...
            <div class="slick-nav-wrap">
                <div class="cms-nav-carousel" data-nav="1" data-dots="true">
                    <?php foreach ($settings['boxs'] as $value_box):
                        if ( !empty($value_box['selected_image']['url'])){
                            ?>
                            <div class="item-image bg-image" style="background-image: url(<?php echo esc_url($value_box['selected_image']['url']); ?>);"></div>
                            <?php
                        }
                        ?>
                    <?php endforeach; ?>
