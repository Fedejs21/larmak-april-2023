...
class Elementor_Theme_Core_Icons_Control extends \Elementor\Base_Data_Control {
    ...
    protected function get_default_settings() {
        ...
        $icons = apply_filters('etc_icons_control_custom_icons', []);
        $icons = array_merge($fontawesome_icons, $icons);
    ...
    function get_fontawesome_icons(){
        ...
        $use_fontawesome = apply_filters('etc_icons_control_use_fontawesome', true);
        ...
        if($use_fontawesome == true){
            ...
            $icons = apply_filters('etc_icons_control_fontawesome_icons', $icons);
        }
